<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="sidebarQLDanhmuc.ascx.cs" Inherits="Project.views.sidebarQLDanhmuc" %>
<div class="col-sm-3">
        ...
        <div class="col-sm-12  div_content">
            ...
            <div class="row margin_b1">
                <div class="list-group font_bold ">
                    ...
                    <a href="/views/kho/show.aspx" class="list-group-item">Quản lý Kho</a>
