<%@ Page Title="" Language="C#" MasterPageFile="~/views/layout/Site.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="Project.views.QLdanhmuc._default" %>
                    ...
                    <div class="col-sm-11  div_content">
                        ...
                        <div class="row margin_b1">
                            <div class="list-group font_bold ">
                                <a href="/views/phong/FormThemPhong.aspx" class="list-group-item">Quản lý Phông lưu trữ</a>
